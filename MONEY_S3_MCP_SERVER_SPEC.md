...
MCP_HOST=127.0.0.1                         # Bind address (default 127.0.0.1; Docker image uses 0.0.0.0)
MCP_AUTH_TOKEN=                            # Bearer token for HTTP auth — required when MCP_HOST is not loopback
```
